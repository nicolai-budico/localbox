...
def resolve_targets(
    ...
    Args:
        ...
        targets: Tuple of target strings (e.g., "projects:api", "services:db").
    ...
    Examples:
        ...
        "projects:api" -> single project named "api"
        ...
        "services:db:primary" -> single service "db:primary"
    """
    ...
    for target in targets:
        ...
        if len(parts) == 1:
            ...
            # "projects:api" or "projects:libs" or "services:db"
            ...
            # "projects:libs:utils" or "services:db:primary"
...
def parse_target(target: str) -> tuple[str, str | None, str | None]:
    ...
    Examples:
        ...
        "projects:api" -> ("projects", None, "api") or \
            ("projects", "api", None) if group

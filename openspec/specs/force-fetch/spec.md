...
Defines the behaviour of the `--force` flag on `localbox projects fetch`. When provided, the command performs a hard reset to a clean copy of the remote branch rather than a rebase-pull.
